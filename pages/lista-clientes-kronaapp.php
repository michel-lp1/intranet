...
$sql = "SELECT * FROM kronaapp ORDER BY id ASC";

if (!empty($_GET['search'])) 
{
      $data = $_GET['search'];
      $sql = "SELECT * FROM kronaapp WHERE id LIKE '%$data%' or cliente LIKE '%$data%' or emailacesso LIKE '%$data%'  ORDER BY id ASC";
                            ...
                            while($user_data = mysqli_fetch_assoc($result))
                                      {
                                            ...
                                            echo "<td>" .$user_data['emailacesso']."</td>";
                                      }
                        ?>  
              </tbody>
        </table>
...
<script>
          ...
          function searchData() 
          {
            ...
            window.location = "lista-clientes-kronaapp.php?search="+search.value;
